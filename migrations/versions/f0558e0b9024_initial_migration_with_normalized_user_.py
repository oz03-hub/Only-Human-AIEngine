...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_members_chatroom_id'), 'members', ['chatroom_id'], unique=False)
    ...
    op.create_index(op.f('ix_questions_chatroom_id'), 'questions', ['chatroom_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_questions_chatroom_id'), table_name='questions')
    op.drop_table('questions')
    op.drop_index(op.f('ix_members_user_id'), table_name='members')
    op.drop_index(op.f('ix_members_id'), table_name='members')
    op.drop_index(op.f('ix_members_chatroom_id'), table_name='members')
